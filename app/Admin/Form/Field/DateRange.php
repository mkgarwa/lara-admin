...
class DateRange extends Field
{
    protected static $css = [
        '/vendor/admin/eonasdan-bootstrap-datetimepicker/build/css/bootstrap-datetimepicker.min.css',
    ];

    protected static $js = [
        '/vendor/admin/moment/min/moment-with-locales.min.js',
        '/vendor/admin/eonasdan-bootstrap-datetimepicker/build/js/bootstrap-datetimepicker.min.js',
    ];
