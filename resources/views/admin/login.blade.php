...
<head>
  ...
  <!-- iCheck -->
  <link rel="stylesheet" href="{{ admin_asset("/vendor/admin/AdminLTE/plugins/iCheck/square/blue.css") }}">
...
<!-- iCheck -->
<script src="{{ admin_asset("/vendor/admin/AdminLTE/plugins/iCheck/icheck.min.js")}}"></script>
<script>
  $(function () {
    $('input').iCheck({
